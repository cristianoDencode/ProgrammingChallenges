...
class CompanyOrderFactory implements OrderFactoryInterface
{
    ...
    {
        return $this->orderData->getCustomerType() === 'CO';
    }
    ...
    public function viewOrder(): void
    {
        ...
        echo "<br> Issuing INVOICE for {$this->orderData->getCustomerName()}" . PHP_EOL;
    }
}